...
One of chromium key security characteristics is that all blink
rendering/javascript code is confined in a sandbox. This sandbox uses
OS-specific features to ensure the renderer process cannot damage the rest of
the system.
